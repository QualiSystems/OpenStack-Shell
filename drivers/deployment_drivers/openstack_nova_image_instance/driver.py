...
from cloudshell.cp.openstack.common.driver_helper import DeployDataHolder
...
class DeployOSNovaImageInstanceDriver(ResourceDriverInterface):
    ...
    def initialize(self, context):
        ...
        self.logger = get_qs_loger(log_category=reservation_id,
                                    log_group=log_group)
    ...
    def Deploy(self, context, Name=None):
        ...
        deploy_req = DeployDataHolder({APP_NAME: app_name,
                                       IMAGE_PARAMS : deploy_service_res_model})
